      ...
      <div className="bg-black pt-20">
        <div className="container m-auto  block md:flex gap-5 px-4">
          <div className="flex flex-col gap-5 justify-center  text-left">
            ...
            <p className="text-lg color-white80 pr-20 mr-20">
              Over the years, I have acquired relevant skills and experience,
              which I shall bring to you. These “why me” reasons should be
              enough to convince someone who is looking for a design solution.
            ...
            <Link className="primary-btn w-max" type="button" href="/contact">
          ...
          <div className='flex flex-col gap-5'>
            <div className="why-box-list flex p-5 rounded-3xl border border-gray-800 gap-5 w-[388px] items-center ml-[-100px]">
              ...
              <div>
                ...
                <p className="color-white80 text-sm">
